...
var docReady = setInterval(function() {
	...
	document.getElementById('create_category').addEventListener('click', createNewCategory);
...
function startDelete(event) {
	//Could open modal to ask if sure
...
function ajax(method, url, params, callback, callbackParams) {
    ...
    // baseUrl variable in set in a <script> in admin-master.blade.php
